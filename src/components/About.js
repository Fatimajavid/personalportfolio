...
function About() {
  ...
  return (
    <section>
      <Container fluid className="about-section" id="about" style={{ padding: "90px" }}>
          ...
          <Row className="d-flex align-items-center justify-content-center" style={{ maxWidth: "1040px", margin: "0 auto", padding: 0 }}>
            <Col md={6} className="text-section" style={{ padding: "0.8rem" }}>
              <h1 className="ibm-plex-serif" style={{ fontSize: "1.8rem" }}>
                Hi there! I'm <span style={{ color: "#ff6b4a" }}>Fatima Javid</span>.
              </h1>
          ...
          <Row style={{ padding: "36px" }}>
            <Col>
              <div style={{ textAlign: "center", lineHeight: "1.6" }}>
                <p className="ibm-plex-serif" style={{ fontSize: "17px", fontWeight: "800", color: "#1a3269" }}>
                  Welcome to my little corner of the web! 
                </p>
                <p className="ibm-plex-serif" style={{ fontSize: "15px" }}>
                ...
                <p className="ibm-plex-serif" style={{ fontSize: "16px" }}>
