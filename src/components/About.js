...
function About() {
  ...
  return (
    <section>
      <Container fluid className="about-section" id="about" style={{ padding: 0 }}>
        <Container className="about-content" style={{ padding: 0 }}>
          <Row className="d-flex align-items-center justify-content-center" style={{ minHeight: "78vh", maxWidth: "1025px", margin: "0 auto", padding: 0 }}>
            
            <Col md={6} className="text-section" style={{ padding: "1rem" }}>
          ...
          <Row style={{ marginTop:"-4.8vh", padding: "0 4rem", marginBottom: "9vh" }}>
          <Col>
